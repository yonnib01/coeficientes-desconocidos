...
"border-color: rgb(167, 0, 83);")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.lineEditA.setText(_translate("MainWindow", "2.5"))
        self.lineEditB.setText(_translate("MainWindow", "1.3"))
        self.lineEditC.setText(_translate("MainWindow", "0.5"))
        self.lineEditD.setText(_translate("MainWindow", "1"))
...
#Metodo para el msgbox **************************************************EDITAR AQUI ********************
    def show_popup(self):
        ...
        msg.setText("EDITAR INSTRUCCIONES AQUI  Y GUIA DE QUE SIGNIFICA ABCD")
